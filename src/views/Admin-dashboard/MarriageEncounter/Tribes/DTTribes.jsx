...
function DTTribes() {
    ...
    function tableSearch() {
        ...
        table = document.getElementById("SEDTTribes");
    ...
    return (
        ...
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <div className='overflow-x-auto overflow-scroll max-h-[600px]'>
                <table id='SEDTTribes' className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
