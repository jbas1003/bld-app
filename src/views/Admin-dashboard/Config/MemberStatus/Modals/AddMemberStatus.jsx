...
function AddMemberStatus({ children, show, setShow }) {
    const content = show && (
        <div className="fixed flex justify-center top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto lg:inset-0 h-modal lg:h-full">
          <div className="relative self-center w-full h-full max-w-lg xl:h-auto">
              <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  <div className="px-6 py-6 lg:px-8">
                    <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Add New Member Status</h3>
                    {children}
                  </div>
              </div>
          </div>
