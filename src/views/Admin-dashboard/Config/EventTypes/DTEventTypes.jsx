...
import { AddNewEventTypes, DeleteEventType, GetAllEventTypes } from '../../../../utils/EventTypeMethods';
...
const DTEventTypes = () => {
    ...
    const editEventType = (eventyTypeName, eventTypeCategory) => {
        setEventTypeName(eventyTypeName);
        setEventTypeCategory(eventTypeCategory);
        setShowEdit(true);
    }

    const showDelete = (eventTypeName) => {
                                    ...
                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap" style={{ cursor: "pointer", width: "20%" }}>
                                            <button type="button"
                                                ...
                                                onClick={() => showDelete(items.event_type_name)}
                                            >
                                            ...
                                            <button type="button"
                                                ...
                                                onClick={() => editEventType(items.event_type_name, items.event_type_category)}
                                            >
                                                <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
