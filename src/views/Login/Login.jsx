      ...
      <div className='flex items-center justify-center h-screen bg-WhiteSmoke font-alegreya'>
        ...
        <div className="w-96 p-6 shadow-2xl bg-WhiteSmoke rounded-lg border-solid border border-DarkRed">
          ...
          <div className='flex justify-end'>
            <button type='submit' className="text-white bg-DarkRed hover:bg-Red focus:ring-4 focus:outline-none focus:ring-Red font-medium rounded-lg text-md w-full sm:w-auto px-5 py-2.5 text-center">Login</button>
          </div>
          </form>
        </div>
      </div>
